...
<body>
    <div class="container">
        ...
        <a href="https://bit.ly/bgsubs" target="_blank" style="display:block; text-align:center; margin:12px 0 20px; padding:12px 20px; background:linear-gradient(135deg,#4ade80 0%,#22c55e 100%); color:#1a1a2e; text-decoration:none; border-radius:10px; font-weight:bold; font-size:14px; transition:transform 0.2s;" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform=''">\u0411\u044a\u043b\u0433\u0430\u0440\u0441\u043a\u0438 \u0441\u0443\u0431\u0442\u0438\u0442\u0440\u0438</a>
