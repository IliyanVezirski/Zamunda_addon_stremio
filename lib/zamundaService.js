...
async function search(uid, pass, query) {
    ...
    console.log(`[Zamunda] Has login: ${html.includes('login.php')}`);
    console.log(`[Zamunda] Has logout: ${html.includes('logout')}`);
    console.log(`[Zamunda] Has cells: ${html.includes('class="cells"')}`);
    console.log(`[Zamunda] First 300 chars: ${html.substring(0, 300)}`);

    if (html.includes('nsls.jpg')) {
        console.log('[Zamunda] Got blocked/seizure page - cookies may be invalid');
    }
