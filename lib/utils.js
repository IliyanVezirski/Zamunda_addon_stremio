...
function extractQuality(title) {
    ...
    if (t.includes('2160p') || t.includes('4k') || t.includes('uhd') || t.includes('remux')) {
        return '4K';
    }
    ...
    if (t.includes('bluray') || t.includes('blu-ray') || t.includes('blu ray') || t.includes('bdrip') || t.includes('bdremux')) {
        return 'BluRay';
    }
    if (t.includes('webrip') || t.includes('web-dl') || t.includes('web dl') || t.includes('webdl') || t.includes('amzn') || t.includes('nf ')) {
        return 'WEB';
    }
    if (t.includes('hdtv') || t.includes('pdtv')) {
        return 'HDTV';
    }
    if (t.includes('dvdrip') || t.includes('dvdscr')) {
        return 'DVDRip';
    }
    if (t.includes('480p') || t.includes('360p')) {
        return '480p';
    }
    if (t.includes('cam') || t.includes('ts ') || t.includes('telesync') || t.includes('hdcam')) {
        return 'CAM';
    }
